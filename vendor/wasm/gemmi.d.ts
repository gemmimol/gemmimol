...
export interface SmallStructureSiteVector extends ClassHandle, Iterable<SmallStructureSite> {
...
export interface SmallStructureAtomTypeVector extends ClassHandle, Iterable<SmallStructureAtomType> {
...
export interface SmallStructure extends ClassHandle {
  cell: UnitCell;
  symops: StringVector;
  sites: SmallStructureSiteVector;
  atom_types: SmallStructureAtomTypeVector;
  ...
  get spacegroup_hall(): string;
  set spacegroup_hall(value: EmbindString);
  get_all_unit_cell_sites(): SmallStructureSiteVector;
  add_site(_0: SmallStructureSite): void;
  setup_cell_images(): void;
  remove_hydrogens(): void;
  change_occupancies_to_crystallographic(_0: number): void;
  determine_and_set_spacegroup(_0: EmbindString): void;
  check_spacegroup(): string;
}
...
export interface Mtz extends ClassHandle {
  ...
  calculate_wasm_map_limited(_0: boolean, _1: number, _2: number): MtzMap | null;
  calculate_wasm_map_from_labels(_0: EmbindString, _1: EmbindString): MtzMap | null;
  calculate_wasm_map_from_labels_limited(_0: EmbindString, _1: EmbindString, _2: number, _3: number): MtzMap | null;
...
interface EmbindModule {
  ...
  SmallStructureSite: {
    new(): SmallStructureSite;
  };
  SmallStructureSiteVector: {
    new(): SmallStructureSiteVector;
  };
  SmallStructureAtomType: {
    new(): SmallStructureAtomType;
  };
  SmallStructureAtomTypeVector: {
    new(): SmallStructureAtomTypeVector;
  };
  SmallStructure: {
    new(): SmallStructure;
  };
  ...
  _read_small_structure(_0: EmbindString, _1: EmbindString): SmallStructure;
